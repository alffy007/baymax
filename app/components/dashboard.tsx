        ...
        <div className="flex min-h-screen w-full">
            ...
            >
                <div className="py-12 bg-slate-100 sm:py-16 lg:py-7 w-full">
                    ...
                    <h1 className="mx-auto text-2xl font-semibold py-8 px-12">Hi Doctor👋</h1>
